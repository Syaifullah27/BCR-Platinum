                            ...
                            <div className="table-container">
                                ...
                                <div className="tablee">
                                    <div className="table-input">
                                        ...
                                        <input 
                                        className={`text-sm ${nameCar ? "hide-arrow" : ""}`} onBlur={handleInputBlur} onFocus={handleInputFocus}
                                        value={nameCar} onChange={handleInputName}
                                            type="text" placeholder="Masukan Nama Mobil" />
                                    </div>
                                    <div className="table-input">
                                        <label>Kategori</label>
                                        <select className={`text-sm  ${capacityCar ? "hide-arrow" : ""}`}
                                    ...
                                    <div className="table-input">
                                        <label>Harga</label>
                                        <select className={`text-sm  ${priceCar ? "hide-arrow" : ""}`}
                                        onBlur={handleInputBlur} onFocus={handleInputFocus}
                                    ...
                                    <div className="table-input">
                                        <label>Status</label>
                                        <select className={`text-sm  ${statusCar ? "hide-arrow" : ""}`}
                                        onBlur={handleInputBlur} onFocus={handleInputFocus}
