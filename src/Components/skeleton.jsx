const Skeleton = () => {
    return (
        <div className="flex flex-col items-center gap-4 border w-[331px] h-[442px] bg-[#F9F9F9] rounded-md ">
            ...
            <div className="skeleton-animation w-[290px] bg-gray-500 rounded-md h-6"></div>
            <div className="skeleton-animation w-[290px] bg-gray-500 rounded-md h-4"></div>
            <div className="skeleton-animation w-[290px] bg-gray-500 rounded-md h-4"></div>
            <div className="flex gap-4 w-full px-5">
                <div className="skeleton-animation w-full bg-gray-500 rounded-md h-10"></div>
